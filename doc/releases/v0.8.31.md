...
-   [src/cli.ts](src/cli.ts) - CLI argument parsing
-   [src/types.ts](src/types.ts) - Type definitions
-   [src/handlers/base.ts](src/handlers/base.ts) - Test environment export
-   [src/services.ts](src/services.ts) - Service script environment
-   [src/artifacts.ts](src/artifacts.ts) - Xcode project configuration
